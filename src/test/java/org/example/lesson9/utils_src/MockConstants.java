...
public class MockConstants {
    ...
    public static final String DELETE_ALL_ADDRESSES = "delete from addresses";
    public static final String DELETE_ALL_PEOPLE = "delete from people";
    ...
    public static final String DELETE_ALL_PERSONS = "delete from people";
