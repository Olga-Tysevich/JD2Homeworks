...
import static org.example.lesson3.Constants.DURATION_OF_STUDY_INDEX_TYPE_3;
...
public class Type3 implements LearningStrategy {
    ...
    public String teachStudent(Student student, Skill skill) {
        ...
        double durationOfStudy = Math.round(skill.getTimeToStudy() * DURATION_OF_STUDY_INDEX_TYPE_3 / student.getTalentValue() * 10) * 0.1;
